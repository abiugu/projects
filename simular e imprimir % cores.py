...
def main():
    ...
    try:
        ...
        while not verificar_stop():
            ...
            # Extrair valores dos elementos <text> dentro das classes recharts-layer recharts-cartesian-axis recharts-xAxis
            for axis_class in driver.find_elements(By.CSS_SELECTOR, ".recharts-layer.recharts-cartesian-axis.recharts-xAxis"):
                text_elements = axis_class.find_elements(By.TAG_NAME, "text")
                for text_element in text_elements:
                    valor = text_element.get_attribute(
                        "innerHTML")  # Extrai o valor
