...
caminho_entrada = os.path.join(os.path.expanduser("~"), "Desktop", "LOGS","resultados", "resultados_52 direto mod.txt")
caminho_saida = os.path.join(os.path.expanduser("~"), "Desktop", "LOGS","percentual", "percentual das jogadas 52 direto mod.txt")
