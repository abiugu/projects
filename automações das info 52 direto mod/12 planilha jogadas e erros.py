...
arquivo_jogadas = os.path.join(logs_path, "sequencias", 'sequencias 52 direto mod.txt')
arquivo_erros = os.path.join(logs_path, "sequencias", 'sequencias erros 52 direto mod.txt')
arquivo_acertos_direto = os.path.join(logs_path, "sequencias", 'sequencias acertos direto 52 mod.txt')
arquivo_acertos_branco = os.path.join(logs_path, "sequencias", 'sequencias acertos branco 52 mod.txt')
arquivo_saida = os.path.join(logs_path, 'planilha acertos 52 direto mod.xlsx')
