...
caminho_entrada = os.path.join(os.path.expanduser("~"), "Desktop", "LOGS", "acertos", "acertos_gale_branco 60.txt")
caminho_saida = os.path.join(os.path.expanduser("~"), "Desktop", "LOGS","percentual", "percentual dos acertos gale branco 60.txt")

# Extrair resultados e porcentagens e salvar em um arquivo
extrair_resultados_porcentagens(caminho_entrada, caminho_saida)

print("Informações salvas em 'percentual dos acertos gale branco 60.txt'.")
