...
def main():
    ...
    print("Acertos Martingale com 38% ou menos:", acertos_martingale_XouMenos, f"({porcentagem_acertos_martingale_XouMenos:.2f}%)")
    print("Acertos Martingale com mais de 38%:", acertos_martingale_maisDeX, f"({porcentagem_acertos_martingale_maisDeX:.2f}%)")
    print("Acertos Martingale com 38% ou menos da cor oposta:", acertos_martingale_XouMenos_oposta, f"({porcentagem_acertos_martingale_XouMenos_oposta:.2f}%)")
    print("Acertos Martingale com mais de 38% da cor oposta:", acertos_martingale_maisDeX_oposta, f"({porcentagem_acertos_martingale_maisDeX_oposta:.2f}%)")
    print("Erros Martingale com 38% ou menos da cor oposta:", erros_martingale_XouMenos_oposta, f"({porcentagem_erros_martingale_XouMenos_oposta:.2f}%)")
    print("Erros Martingale com mais de 38% da cor oposta:", erros_martingale_maisDeX_oposta, f"({porcentagem_erros_martingale_maisDeX_oposta:.2f}%)")
    print("Erros Martingale com 38% ou menos da mesma cor:", erros_martingale_XouMenos_mesmaCor, f"({porcentagem_erros_martingale_XouMenos_mesmaCor:.2f}%)")
    print("Erros Martingale com mais de 38% da mesma cor:", erros_martingale_maisDeX_mesmaCor, f"({porcentagem_erros_martingale_maisDeX_mesmaCor:.2f}%)")
