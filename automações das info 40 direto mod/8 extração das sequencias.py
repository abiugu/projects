...
arquivo_entrada1 = "resultados_40 direto mod.txt"
arquivo_entrada2 = "resultados_erros_log_40 direto mod.txt"
arquivo_entrada3 = "resultados_acertos_direto_40 direto mod.txt"
arquivo_entrada4 = "resultados_acertos_branco_40 direto mod.txt"

# Caminhos dos arquivos de saída
caminho_saida1 = os.path.join(os.path.expanduser("~"), "Desktop", "LOGS", "sequencias", "sequencias 40 direto mod.txt")
caminho_saida2 = os.path.join(os.path.expanduser("~"), "Desktop", "LOGS", "sequencias", "sequencias erros 40 direto mod.txt")
caminho_saida3 = os.path.join(os.path.expanduser("~"), "Desktop", "LOGS", "sequencias", "sequencias acertos direto 40 mod.txt")
caminho_saida4 = os.path.join(os.path.expanduser("~"), "Desktop", "LOGS", "sequencias", "sequencias acertos branco 40 mod.txt")
