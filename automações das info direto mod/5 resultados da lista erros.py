...
# Arquivo a ser lido
arquivo_entrada = os.path.join(diretorio_logs,'erros', "erros log 48 direto.txt")
# Arquivo de saída
arquivo_saida = os.path.join(diretorio_logs,'resultados', "resultados_erros_log_48 direto.txt")
