...
arquivo_jogadas = os.path.join(logs_path, "sequencias", 'sequencias 48 direto mod.txt')
arquivo_erros = os.path.join(logs_path, "sequencias", 'sequencias erros 48 direto.txt')
arquivo_acertos_direto = os.path.join(logs_path, "sequencias", 'sequencias acertos direto 48 mod.txt')
arquivo_acertos_branco = os.path.join(logs_path, "sequencias", 'sequencias acertos branco 48 mod.txt')
arquivo_saida = os.path.join(logs_path, 'planilha acertos 48 direto mod.xlsx')
