...
class Double:
    def __init__(
        ...
        self.url = f"https://blaze-7.com/api/roulette_games/history?startDate={self.start_date}T{self.cur_hour}.369Z&endDate={self.end_date}T{self.cur_hour}.370Z&page=1"
