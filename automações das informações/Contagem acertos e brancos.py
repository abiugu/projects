...
def extrair_maiores_acertos_e_contar_white(arquivo_log):
    ...
    with open(arquivo_log, 'r') as arquivo:
        ...
        for i in range(len(linhas)):
            linha = linhas[i]
            if 'Acertos direto:' and 'Acertos gale:' in linha:
...
maiores_acertos_diretos, maiores_acertos_gale, contador_white_apos_alarme = extrair_maiores_acertos_e_contar_white(
    caminho_arquivo)
