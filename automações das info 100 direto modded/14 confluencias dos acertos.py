...
arquivo_entrada = os.path.join(os.path.expanduser("~"), "Desktop", "LOGS", "resultados", "resultados_acertos_direto_100 direto modded.txt")
arquivo_saida = os.path.join(os.path.expanduser("~"), "Desktop", "LOGS", "confluencias", "confluencia_acertos_100_direto_modded.txt")
