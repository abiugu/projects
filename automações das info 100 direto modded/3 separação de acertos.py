...
caminho_arquivo = os.path.join(os.path.expanduser('~'), 'Desktop', 'LOGS', 'log 100 direto modded.txt')
...
caminho_saida_brancos = os.path.join(os.path.expanduser('~'), 'Desktop', 'LOGS', 'acertos', 'acertos_branco 100 modded.txt')
caminho_saida_diretos = os.path.join(os.path.expanduser('~'), 'Desktop', 'LOGS', 'acertos', 'acertos_direto 100 modded.txt')
