...
# Arquivo a ser lido
arquivo_entrada = os.path.join(diretorio_logs,'erros', "erros log 100 direto mod.txt")
# Arquivo de saída
arquivo_saida = os.path.join(diretorio_logs,'resultados', "resultados_erros_log_100 direto mod.txt")
