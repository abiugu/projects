...
# Arquivo a ser lido
arquivo_entrada = os.path.join(diretorio_logs,'erros', "erros log 100 direto modded.txt")
# Arquivo de saída
arquivo_saida = os.path.join(diretorio_logs,'resultados', "resultados_erros_log_100 direto modded.txt")
